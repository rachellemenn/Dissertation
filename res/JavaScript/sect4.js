...
function Visualization(fileName) {
    ...
    var loaders = [
        ...
        new Loader("Assets/Data/Vizual13.csv", this.DrawSimpleChart),
        new Loader("Assets/Data/Viz13.3.csv", this.DrawSimpleChart),
        new Loader("Assets/Data/Viz13.2.csv", this.DrawSimpleChart),
        new Loader("Assets/Data/Viz13.1.csv", this.DrawSimpleChart),
