...
function Visualization(fileName) {
    ...
    this.Viz151 = function (data) {
        //donut chart for 15.1.csv
    }

    // this.Viz153 = function (data) {
    //     // for 15.2.csv
    //     var tau = 2 * Math.PI; // http://tauday.com/tau-manifesto
    ...
    //         foreground.transition()
    //             .duration(750)
    //             .attrTween("d", arcTween(data.Value * tau));
    //     }, 1500);
    ...
    var loaders = [
        ...
        new Loader("Assets/Data/Viz11.1.csv", this.DrawSimpleChart),
        ...
        new Loader("Assets/Data/Vizual13.csv", this.Viz8),
                ...
                if (indexToDraw != -1 && indexToDraw != lastDrawnIndex) {
                    ...
                    /*d3.selectAll('.step')
                        .style('opacity', function (d, i) {
                            return i === indexToDraw ? 1 : 0.1;
                        });

                    console.log("Adding div");
                    var div = d3.select("#sections")
                        .append("div")
                        .style("width", "100%")
                        .attr("id", "__dummy__");

                    console.log("div", div);
                    console.log("Resizing and removng div");

                    div = d3.select("#__dummy__");
                    console.log("div __dummy__", div);
                    var divWidth = +div.style("width");
                    div.style("width", function (d) {
                            console.log("d 1: ", d);
                            return "" + (divWidth - 1) + "px";
                        })
    ...
    function SetOpacityAndFixDom(index) {
