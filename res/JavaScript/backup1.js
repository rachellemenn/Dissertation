...
function Visualization(fileName) {
    ...
    window.onload = () => {
        ...
        button2 = button2()
            .container(d3.select(".step"));
        

        // pass in .step selection as the steps
        button1(d3.selectAll('#vis'));
        button2(d3.selectAll('.step'));

        // setup event handling
        button1.click('active', (index) => {
            ...
            if(indexToDraw.button1 >=loaders.length) {

            }
        });

        // setup event handling
        button2.click('active', (index) => {
            console.log("Active on index " + index);
            ...
            if (indexToDraw.button2 >= loaders.length) {
