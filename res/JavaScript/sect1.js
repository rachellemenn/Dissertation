...
*/
    ...
    function InitComputeSizes()
    {
        ...
        console.log("bounding rectangle", r);
        offset = r.bottom;
    ...
    function ComputeSizes()
    {
        ...
        // We want to make sure our sizes are at least 1/3 of the width.
        var targetWidth = Math.floor(winWidth / 3);
        console.log("TargetWidth " + targetWidth);
        // We based our calculations on 800px, compute the ratio
        var ratio = targetWidth / 800;
        ...
        steps.forEach(function(s) {
            s.style.marginBottom = Math.floor(stepMarginBottom * ratio).toString() + "px";
        });
        ...
        margin.top = Math.floor(40 * ratio);
        margin.left = Math.floor(20 * ratio);
        margin.bottom = Math.floor(10 * ratio);
        margin.right = Math.floor(10 * ratio);
