...
// A class to view text
function WrittenContent(fileName) {
    var width = 400;
    var height = 520;
    var margin = {
        top: 40,
    ...
    this.LoadWrittenContent = function (data) {
            clearSvgContainer();
            document.getElementById("step").innerHTML = "<div class='MainContent'>" + data[0].Text + "</div>";
        }

        var loaders = [
            /*  0 */
            new Loader("Assets/Data/Subtitle.txt", this.LoadWrittenContent),
            /*  1 */
            new Loader("Assets/Data/1.1.txt", this.LoadWrittenContent),
            /*  2 */
            new Loader("Assets/Data/blockquotes.txt", this.LoadWrittenContent),
            /*  3 */
            new Loader("Assets/Data/1.2.txt", this.LoadWrittenContent),
            /*  4 */
            new Loader("Assets/Data/1.3.txt", this.LoadWrittenContent),
            /*  5 */
            new Loader("Assets/Data/1.4.txt", this.LoadWrittenContent),
            /*  6 */
            new Loader("Assets/Data/blockquotes.txt", this.LoadWrittenContent),
            /*  7 */
            new Loader("Assets/Data/2.1.txt", this.LoadWrittenContent),
            /*  8 */
            new Loader("Assets/Data/2.2.txt", this.LoadWrittenContent),
            /*  9 */
            new Loader("Assets/Data/2.3.txt", this.LoadWrittenContent),
            /* 10 */
            new Loader("Assets/Data/2.4.txt", this.LoadWrittenContent),
            /* 11 */
            new Loader("Assets/Data/blockquotes.txt", this.LoadWrittenContent),
            /* 12 */
            new Loader("Assets/Data/2.5.txt", this.LoadWrittenContent),
            /* 13 */
            new Loader("Assets/Data/blockquotes.txt", this.LoadWrittenContent),
            /* 14 */
            new Loader("Assets/Data/3.1.txt", this.LoadWrittenContent),
            /* 15 */
            new Loader("Assets/Data/3.2.txt", this.LoadWrittenContent),
            /* 16 */
            new Loader("Assets/Data/blockquotes.txt", this.LoadWrittenContent),
            /* 17 */
            new Loader("Assets/Data/3.3.txt", this.LoadWrittenContent),
            /* 18 */
            new Loader("Assets/Data/3.4.txt", this.LoadWrittenContent),
            /* 19 */
            new Loader("Assets/Data/3.5.txt", this.LoadWrittenContent),
            /* 20 */
            new Loader("Assets/Data/blockquotes.txt", this.LoadWrittenContent),
            /* 21 */
            new Loader("Assets/Data/4.1.txt", this.LoadWrittenContent),
            /* 22 */
            new Loader("Assets/Data/4.2.txt", this.LoadWrittenContent),
            /* 23 */
            new Loader("Assets/Data/blockquotes.txt", this.LoadWrittenContent),
            /* 24 */
            new Loader("Assets/Data/4.3.txt", this.LoadWrittenContent),
            /* 25 */
            new Loader("Assets/Data/4.4.txt", this.LoadWrittenContent),
            /* 26 */
            new Loader("Assets/Data/blockquotes.txt", this.LoadWrittenContent),
            /* 27 */
            new Loader("Assets/Data/4.5.txt", this.LoadWrittenContent),
            /* 28 */
            new Loader("Assets/Data/4.6.txt", this.LoadWrittenContent),
            /* 29 */
            new Loader("Assets/Data/4.7.txt", this.LoadWrittenContent),
            /* 30 */
            new Loader("Assets/Data/4.8.txt", this.LoadWrittenContent),
            /* 31 */
            new Loader("Assets/Data/4.9.txt", this.LoadWrittenContent),
            /* 32 */
            new Loader("Assets/Data/blockquote.txt", this.LoadWrittenContent),
            /* 33 */
            new Loader("Assets/Data/4.10.txt", this.LoadWrittenContent),
            /* 34 */
            new Loader("Assets/Data/4.11.txt", this.LoadWrittenContent),
            /* 35 */
            new Loader("Assets/Data/blockquotes.txt", this.LoadWrittenContent),
            /* 36 */
            new Loader("Assets/Data/4.12.txt", this.LoadWrittenContent),
            /* 37 */
            new Loader("Assets/Data/4.13.txt", this.LoadWrittenContent),
            /* 38 */
            new Loader("Assets/Data/4.14.txt", this.LoadWrittenContent),
            /* 39 */
            new Loader("Assets/Data/blockquote.txt", this.LoadWrittenContent),
            /* 40 */
            new Loader("Assets/Data/4.15.txt", this.LoadWrittenContent),
            /* 41 */
            new Loader("Assets/Data/4.16.txt", this.LoadWrittenContent),
            /* 42 */
            new Loader("Assets/Data/blockquotes.txt", this.LoadWrittenText),
            /* 43 */
            new Loader("Assets/Data/4.17.txt", this.LoadWrittenContent),
            /* 44 */
            new Loader("Assets/Data/4.18.txt", this.LoadWrittenContent),
            /* 45 */
            new Loader("Assets/Data/5.1.txt", this.LoadWrittenContent),
            /* 46 */
            new Loader("Assets/Data/blockquotes.txt", this.LoadWrittenContent),
        ];
        ...
        button.click = () => {
            ...
            container = d3.selectAll("#sections")
                .append("svg:svg")
...
function Visualization(fileName) {
    ...
    button.click = () => {
        ...
        // Create the container in element that has #vis
        container = d3.selectAll("#svgContainer")
            .append("svg:svg")
            .attr("width", width + margin.left + margin.right)
            .attr("height", height + margin.top + margin.bottom);
